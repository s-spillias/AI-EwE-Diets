...
Our validation framework assessed three key aspects of the AI-assisted ecosystem modelling approach: reproducibility of species groupings, consistency of food web construction, and accuracy against expert-derived matrices.
...
\subsection{Food Web Reproducibility}
...
\subsubsection{Food Web Accuracy}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/annotations_by_functional_group.png}
